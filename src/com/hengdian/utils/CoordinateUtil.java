...
public class CoordinateUtil {
	 ...
	 * @return GCJ 经纬度对象
	 */
	public static LoLatitude transformWGS2GCJ(LoLatitude wgLoc) {

		// 如果在国外，则默认不进行转换
		if (outOfChina(wgLoc.latitude, wgLoc.longitude)) {
			return new LoLatitude(wgLoc.latitude, wgLoc.longitude);
		}
		...
		return new LoLatitude(wgLoc.latitude + dLat, wgLoc.longitude + dLon);
	}
